...
public class BroadcastProtocol {
    ...
    public static void main(String[] args) throws IOException,
        ...
        while (true) {
            checkDeliver(c_messages_sent, messages_sent, context, true, counter_debit, debit, timer);
            checkDeliver(c_messages_received, messages_received, context, false, counter_debit, debit, timer);
        }

    }

    public static void deliver(String s, boolean sent, DeliveredCounter counter_debit, boolean debit, long timer) {
        if (!debit) {
    ...
    public static void checkDeliver(
        ...
        for (String s : messages_to_deliver) {
            ...
            deliver(message_hash.get(s), sent, counter_debit, debit, timer);
